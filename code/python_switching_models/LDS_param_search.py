...
if fold_number == 1:
    log_likelihood_emissions_sum.to_csv(folderpath_out + str(num_dims) +
                                        "_dims_test_emissions_ll.csv", index=False, header=False)
elif fold_number > 1:
    log_likelihood_emissions_sum.to_csv(folderpath_out + str(num_dims) +
                                        "_dims_test_emissions_ll.csv", mode='a', index=False, header=False)
