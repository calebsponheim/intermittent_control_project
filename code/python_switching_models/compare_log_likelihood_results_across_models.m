...
if contains(subject,'RS') && contains(task,'RTP')
...
elseif contains(subject,'RJ') && contains(task,'RTP')
    num_latent_dims_rslds = 25;
    num_discrete_states_rslds = 10;
    num_latent_dims_slds = 2;
    num_discrete_states_slds = 2;
...
elseif contains(subject,'Bx') && contains(task,'RTP')
...
plot(2:(length(lds_ll)),lds_ll(2:end),'color','k','linewidth',2)
