...
def train_HMM(
    ...
    #         second_term = (timestep_temp) * math.log(mean_spikecount_temp)
    #         third_term = math.log(math.factorial(timestep_temp))
    #         per_timestep_likelihood.append(
    #             -first_term + sum(second_term) - sum(third_term)
    #         )

    #     per_neuron_likelihood.append(sum(per_timestep_likelihood))

    # max_log_likelihood_possible = sum(per_neuron_likelihood)
    # ninety_percent_threshold = max_log_likelihood_possible + (
    #     max_log_likelihood_possible * 0.1
    # )
