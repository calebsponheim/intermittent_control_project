...
python /project/nicho/caleb/git/intermittent_control_project/code/python_switching_models/run_param_search.py $SLURM_ARRAY_TASK_ID 4 4 rs RTP 1
sbatch --dependency=afterany:$SLURM_JOB_ID sbatch_dims_2-80_state_4_fold_4_train-model_0