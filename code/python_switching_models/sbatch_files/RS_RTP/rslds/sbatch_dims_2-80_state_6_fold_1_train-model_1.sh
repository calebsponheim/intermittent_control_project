...
python /project/nicho/caleb/git/intermittent_control_project/code/python_switching_models/run_param_search.py $SLURM_ARRAY_TASK_ID 1 6 rs RTP 1sbatch --dependency=afterany:$SLURM_JOB_ID sbatch_dims_2-80_state_6_fold_1_train-model_0