...
python /project/nicho/caleb/git/intermittent_control_project/code/python_switching_models/run_param_search.py 2 4 4 rs RTP 1
sbatch --dependency=afterany:$SLURM_JOB_ID sbatch_2_dims_4_states_4_folds_train-model_0.sh