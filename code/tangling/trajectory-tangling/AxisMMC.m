...
%                                 hint: arrayfun(@(n) {num2str(n)},params.tickLabelLocations)
...
for i = 1:length(tickLabelLocations)
    ...
    set(h,'HorizontalA', NalignH, 'VerticalA', NalignV, 'fontsize', fontSize, 'color', color);
end
...
set(h,'HorizontalA', LalignH, 'VerticalA', LalignV, 'fontsize', fontSize*1.1, 'color', color);
