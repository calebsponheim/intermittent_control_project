...
[~, ~, ~, q_temp, ~] = al_goodplot(bx_curves,1,0.75, colors(1,:), 'right', 100,std(bx_curves)/10000,1);
q(1) = q_temp(7,1);
[~, ~, ~, q_temp, ~] = al_goodplot(rs_curves,2,0.75, colors(2,:), 'right', 100,std(rs_curves)/10000,1);
q(2) = q_temp(7,1);
[~, ~, ~, q_temp, ~] = al_goodplot(rj_curves,3,0.75, colors(3,:), 'right', 100,std(rj_curves)/10000,1);
q(3) = q_temp(7,1);
